...
export default function ScenarioCard({
  ...
  return (
    <div
      className={`ui-card-motion shrink-0 overflow-hidden rounded-[18px] bg-white p-5 shadow-[0_6px_24px_rgba(15,23,42,0.07)] ring-1 ring-slate-100 ${cardClassName}`}
      style={{
        '--ui-card-delay': `${animationDelayMs}ms`,
