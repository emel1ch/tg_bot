...
export default function GameLink({ onBack }) {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-violet-50 via-white to-slate-50 px-4 py-5">
      <div className="mx-auto flex w-full max-w-md flex-col">
        ...
        <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <button
            onClick={openGame}
            className="mt-6 w-full rounded-2xl bg-violet-600 px-5 py-4 text-base font-semibold text-white shadow-sm transition hover:bg-violet-700 active:scale-[0.99]"
          >
            Открыть игру
          </button>
        </div>
